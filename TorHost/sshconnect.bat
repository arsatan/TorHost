...
ssh -v -i %USERPROFILE%/id_rsa -o "ProxyCommand=./Ncat/ncat.exe --proxy 127.0.0.1:9050 --proxy-type socks5 %h %p" roman@y6px4gw3zhmmfwklkg6pgrpb4rs3cdmftlkeitw4peexhdkbaptnn6yd.onion
